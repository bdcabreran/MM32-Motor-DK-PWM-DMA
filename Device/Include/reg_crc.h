...
#define CRC_CR_MGN_Pos                  (1)                                     ///< Algorithm selection
#define CRC_CR_MGN                      (0x01U << CRC_CR_MGN_Pos)
#define CRC_CR_BITSEL_Pos               (2)
#define CRC_CR_BITSEL_0                 (0x00U << CRC_CR_BITSEL_Pos)             ///< Input bit width selection 8 bit
#define CRC_CR_BITSEL_1                 (0x01U << CRC_CR_BITSEL_Pos)             ///< Input bit width selection 16 bit
#define CRC_CR_BITSEL_2                 (0x02U << CRC_CR_BITSEL_Pos)             ///< Input bit width selection 32 bit
#define CRC_CR_BIG_EI_Pos               (4)
#define CRC_CR_BIG_EI                   (0x01U << CRC_CR_BIG_EI_Pos)             ///<  big endian input 
#define CRC_CR_BIG_EO_Pos               (5)
#define CRC_CR_BIG_EO                   (0x01U << CRC_CR_BIG_EO_Pos)             ///< big endian output
