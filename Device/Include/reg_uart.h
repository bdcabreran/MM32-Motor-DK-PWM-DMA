...
#define UART_TDR_DATA                   (0x1FFU << UART_TDR_DATA_Pos)            ///< Transmit data register

////////////////////////////////////////////////////////////////////////////////
/// @brief UART_RDR Register Bit Definition
////////////////////////////////////////////////////////////////////////////////
#define UART_RDR_DATA_Pos               (0)
#define UART_RDR_DATA                   (0x1FFU << UART_RDR_DATA_Pos)            ///< Receive data register
...
#define UART_BRR_FRACTION            (0xFFFFU << UART_BRR_FRACTION_Pos)        ///< UART DIV FRACTION
...
////////////////////////////////////////////////////////////////////////////////
#define UART_IIRDA_SIREN_Pos         (0)
#define UART_IIRDA_SIREN             (0xFFU << UART_IIRDA_SIREN_Pos)           ///< IrDA mode enable
#define UART_IIRDA_SIRLP_Pos         (1)
#define UART_IIRDA_SIRLP             (0xFFU << UART_IIRDA_SIRLP_Pos)           ///< IrDA low_power 

#define UART_IIRDA_PSC_REG_Pos       (8)
#define UART_IIRDA_PSC_REG           (0xFFU << UART_IIRDA_PSC_REG_Pos)         ///< Prescaler value
