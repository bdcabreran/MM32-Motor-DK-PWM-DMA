...
#define LED_ERROR_FLASH_ON_TICKS ms_Conversion(LED_RGYW_ERROR_FLASH_ON_TIME, SPEED_LEVEL_CHANGE_SUBSYSTEM_FREQUENCY)
#define LED_ERROR_FLASH_OFF_TICKS ms_Conversion(LED_RGYW_ERROR_FLASH_OFF_TIME, SPEED_LEVEL_CHANGE_SUBSYSTEM_FREQUENCY)
...
#define LED_RGYW_ERROR_FLASH_ON_TICKS ms_Conversion(LED_RGYW_ERROR_FLASH_ON_TIME, LED_RGYW_SUBSYSTEM_FREQUENCY)
#define LED_RGYW_ERROR_FLASH_OFF_TICKS ms_Conversion(LED_RGYW_ERROR_FLASH_OFF_TIME, LED_RGYW_SUBSYSTEM_FREQUENCY)
...
#define LED_RGYW_BATTERY_FLASH_ON_TICKS ms_Conversion(LED_RGYW_BATTERY_FLASH_ON_TIME, LED_RGYW_SUBSYSTEM_FREQUENCY)
#define LED_RGYW_BATTERY_FLASH_OFF_TICKS ms_Conversion(LED_RGYW_BATTERY_FLASH_OFF_TIME, LED_RGYW_SUBSYSTEM_FREQUENCY)
