...
typedef struct {
    ...
    union {
        __IO u32 RESERVED_0x10;                                                 ///<                                                offset: 0x10
        __IO u32 OPAMP_CSR;
    };
    union {
...
////////////////////////////////////////////////////////////////////////////////
/// @brief COMP_CSR (1,2,3,4,5) Register Bit Definition
////////////////////////////////////////////////////////////////////////////////
...
#define COMP_CSR_OUT_TIM1_BRAKE         (0x02U << COMP_CSR_OUT_Pos)             ///< Timer1 break input
#define COMP_CSR_OUT_TIM8_BRAKE         (0x03U << COMP_CSR_OUT_Pos)             ///< Timer8 break input
...
#define COMP_CSR_HYST_0                 (0x00U << COMP_CSR_HYST_Pos)            ///< Hysteresis Voltage: 0 mV
#define COMP_CSR_HYST_1                 (0x01U << COMP_CSR_HYST_Pos)            ///< Hysteresis Voltage: 9 mV
#define COMP_CSR_HYST_2                 (0x02U << COMP_CSR_HYST_Pos)            ///< Hysteresis Voltage: 18mV
#define COMP_CSR_HYST_3                 (0x03U << COMP_CSR_HYST_Pos)            ///< Hysteresis Voltage: 27mV

#define COMP45_CSR_HYST_0MV             (0x00U << COMP_CSR_HYST_Pos)            ///< Hysteresis Voltage: 0 mV
#define COMP45_CSR_HYST_9MV             (0x01U << COMP_CSR_HYST_Pos)            ///< Hysteresis Voltage: 15mV
#define COMP45_CSR_HYST_18MV            (0x02U << COMP_CSR_HYST_Pos)            ///< Hysteresis Voltage: 30mV
#define COMP45_CSR_HYST_27MV            (0x03U << COMP_CSR_HYST_Pos)            ///< Hysteresis Voltage: 90mV

#define COMP123_CSR_HYST_0MV            (0x00U << COMP_CSR_HYST_Pos)            ///< Hysteresis Voltage: 0 mV
#define COMP123_CSR_HYST_9MV            (0x01U << COMP_CSR_HYST_Pos)            ///< Hysteresis Voltage: 9 mV
#define COMP123_CSR_HYST_18MV           (0x02U << COMP_CSR_HYST_Pos)            ///< Hysteresis Voltage: 18mV
#define COMP123_CSR_HYST_27MV           (0x03U << COMP_CSR_HYST_Pos)            ///< Hysteresis Voltage: 27mV

#define COMP_CSR_OFLT_Pos               (18)
#define COMP_CSR_OFLT                   (0x07U << COMP_CSR_OFLT_Pos)            ///< Comparator output filter
#define COMP_CSR_OFLT_0                 (0x00U << COMP_CSR_OFLT_Pos)            ///< 0   or  0  clock cycle       
#define COMP_CSR_OFLT_1                 (0x01U << COMP_CSR_OFLT_Pos)            ///< 2   or  4  clock cycle    
#define COMP_CSR_OFLT_2                 (0x02U << COMP_CSR_OFLT_Pos)            ///< 4   or  16  clock cycle    
#define COMP_CSR_OFLT_3                 (0x03U << COMP_CSR_OFLT_Pos)            ///< 8   or  32  clock cycle    
#define COMP_CSR_OFLT_4                 (0x04U << COMP_CSR_OFLT_Pos)            ///< 16  or  64  clock cycle    
#define COMP_CSR_OFLT_5                 (0x05U << COMP_CSR_OFLT_Pos)            ///< 32  or  128  clock cycle    
#define COMP_CSR_OFLT_6                 (0x06U << COMP_CSR_OFLT_Pos)            ///< 64  or  256  clock cycle    
#define COMP_CSR_OFLT_7                 (0x07U << COMP_CSR_OFLT_Pos)            ///< 128 or  512  clock cycle    
...
////////////////////////////////////////////////////////////////////////////////
/// @brief COMP_CSR (4,5) Register Bit Definition
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// @brief COMP_CSR (1,2,3) Register Bit Definition
////////////////////////////////////////////////////////////////////////////////
