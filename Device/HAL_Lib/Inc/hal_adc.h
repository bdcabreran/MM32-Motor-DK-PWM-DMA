...
typedef enum {
    ...
    ADC_Channel_VoltReference           = 0x0E,                                 ///< Internal reference voltage(ADC1) channel
    ADC_Channel_Vrefint                 = 0x0E,                                 ///< Internal reference voltage(ADC1) channel
    ADC_Channel_TempSensor              = 0x0F,                                 ///< Temperature sensor channel(ADC1)
} ADCCHANNEL_TypeDef;
...
typedef enum {
    ...
    ADC_Samctl_6_5      = ADC_SMPR_SAMCTL_6_5,                                  ///< ADC sample time select 6.5t
    ADC_Samctl_7_5      = ADC_SMPR_SAMCTL_7_5,                                  ///< ADC sample time select 7.5t
    ADC_Samctl_11_5     = ADC_SMPR_SAMCTL_11_5,                                 ///< ADC sample time select 2.5t
    ADC_Samctl_13_5     = ADC_SMPR_SAMCTL_13_5,                                 ///< ADC sample time select 2.5t
    ADC_Samctl_15_5     = ADC_SMPR_SAMCTL_15_5,                                 ///< ADC sample time select 2.5t
    ADC_Samctl_19_5     = ADC_SMPR_SAMCTL_19_5,                                 ///< ADC sample time select 2.5t
    ADC_Samctl_29_5     = ADC_SMPR_SAMCTL_29_5,                                 ///< ADC sample time select 8.5t
    ADC_Samctl_39_5     = ADC_SMPR_SAMCTL_39_5,                                 ///< ADC sample time select 14.5t
    ADC_Samctl_59_5     = ADC_SMPR_SAMCTL_59_5,                                 ///< ADC sample time select 29.5t
    ADC_Samctl_79_5     = ADC_SMPR_SAMCTL_79_5,                                 ///< ADC sample time select 42.5t
    ADC_Samctl_119_5    = ADC_SMPR_SAMCTL_119_5,                                ///< ADC sample time select 56.5t
    ADC_Samctl_159_5    = ADC_SMPR_SAMCTL_159_5,                                ///< ADC sample time select 72.5t
...
typedef enum {
    ...
    ADC1_ExternalTrigConv_T1_CC4        = ADC_CR_T1_CC4,
    ADC1_ExternalTrigConv_T1_CC5        = ADC_CR_T1_CC5,
    ADC2_ExternalTrigConv_T1_CC1        = ADC_CR_T1_CC1,
    ADC2_ExternalTrigConv_T1_CC2        = ADC_CR_T1_CC2,
    ADC2_ExternalTrigConv_T1_CC3        = ADC_CR_T1_CC3,
    ADC2_ExternalTrigConv_T2_CC2        = ADC_CR_T2_CC2,
    ADC2_ExternalTrigConv_T3_TRIG       = ADC_CR_T3_TRIG,
    ADC2_ExternalTrigConv_T1_CC4_CC5    = ADC_CR_T1_CC4_CC5,
    ADC2_ExternalTrigConv_T3_CC1        = ADC_CR_T3_CC1,
    ADC2_ExternalTrigConv_EXTI_11       = ADC_CR_EXTI_11,
    ADC2_ExternalTrigConv_T1_TRIG       = ADC_CR_T1_TRIG,
    ADC2_ExternalTrigConv_T8_CC4_CC5    = ADC_CR_T8_CC4_CC5,
    ADC2_ExternalTrigConv_T8_CC4        = ADC_CR_T8_CC4,
...
typedef enum {
    ...
    ADC1_InjectExtTrigSrc_T8_CC4_CC5    = ADC_ANY_CR_JTRGSEL_TIM8_CC4_CC5,      ///< TIM8  CC4 CC5
    ...
    ADC1_InjectExtTrigSrc_T8_CC5        = ADC_ANY_CR_JTRGSEL_TIM8_CC5,          ///< TIM8  CC5
