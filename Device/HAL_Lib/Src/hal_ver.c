...
// MM32 Library version is 0.6.0.0

#define __MM32_LIB_VERSION_MAIN         (0x00U)                                 //!< [31:24] main version 
#define __MM32_LIB_VERSION_SUB1         (0x06U)                                 //!< [23:16] sub1 version
...
// MM32 Library release date is 2022-01-07 (YYYY-MM-DD)
...
#define __MM32_LIB_RELESE_DAY           (0x07U)                                 //!< [7:0]   release day
