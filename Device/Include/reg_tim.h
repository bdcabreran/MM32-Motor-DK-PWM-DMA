...
typedef struct {
    ...
    __IO u32 RESERVE0x50;                                                       ///< reserve,                                       offset: 0x50
    ...
    __IO u32 BKINF;                                                             ///< break input filter register                    offset: 0x74
} TIM_TypeDef;
...
#define TIM_BKINF_BKINF             (0x0FU << TIM_BKINF_BKINF_Pos)          ///< break input filter 128 
