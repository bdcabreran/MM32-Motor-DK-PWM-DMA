...
typedef struct {
    ...
    __IO u32 RESERVED0x0C;                                                    ///< Reserved Register                              offset: 0x0C
    union {
    ...
    __IO u32 RESERVED0x24;                                                     ///< Reserved Register                              offset: 0x24
    __IO u32 RESERVED0x28;                                                     ///< Reserved Register                              offset: 0x28
    union {
    ...
    __IO u32 RESERVED0x80;                                                     ///< Reserved;                                       offset: 0x80
    __IO u32 RESERVED0x84;                                                     ///< Reserved;                                       offset: 0x84

    union {
        __IO u32 DMA;                                                          ///< DMA Control Register                           offset: 0x88
        __IO u32 IC_DMA_CR;
    };
    __IO u32 RESERVED[2];                                                      ///< Reserved;                                       offset: 0x8C~0x90
    union {
    ...
    __IO u32 RESERVED1[5];                                                     ///< Reserved;                                     offset: 0x9C~0xAC
