...
#define SYSCFG_CFGR_CSMCH2_DMA_RMP         (0x01U  << SYSCFG_CFGR_CSMCH2_DMA_RMP_Pos)                   ///< CSMCH2 DMA remap
#define SYSCFG_CFGR_SYS_IRQLATENCY_Pos     (16)
#define SYSCFG_CFGR_SYS_IRQLATENCY         (0xFFU  << SYSCFG_CFGR_SYS_IRQLATENCY_Pos)                   ///< System interrupt request delay configuration
#define SYSCFG_CFGR_AMP_DACEN_Pos          (24)
#define SYSCFG_CFGR_AMP_DACEN              (0xFFU  << SYSCFG_CFGR_CSMCH1_DMA_RMP_Pos)                   ///< The input of amp1 selects the output signal of DAC
